...
players_by_country <- map %>% 
  ...
  ggplot() +
    ...
    scale_color_manual(values = c("#838383", "#17B1A7"), guide = "none") + # define manual colors for highlight countries of interest
    scale_fill_gradient(
    low = "#E4F2E7",
    high = '#00381F',
    na.value = "lightgrey",
  ...
  # Change labels
  labs(title = "<b><span style='color:#17B1A7'> Liverpool</span> historically sourced their players from the same areas as the rest of the Premier League</span></b><br>
...
#read csv file
data_dir <- "~/Desktop/r_folder/am10-group8-football-project/data/transfer"
...
img1 <- readPNG("~/Desktop/r_folder/am10-group8-football-project/players_photo/torres.png")
...
img2 <- readPNG("~/Desktop/r_folder/am10-group8-football-project/players_photo/dijk.png")
...
annotation3 <- data.frame(
   ...
   y = 25,
   label = c("Takumi \n Minamino \n from \n Red Bull \n Salzburg "))
img3 <- readPNG("~/Desktop/r_folder/am10-group8-football-project/players_photo/takumi.png")
