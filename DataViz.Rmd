...
![](liv22.png)We are going to analyze the reason from player's performance in different positions.

## Attacking

![](Attack.png){width="412"}
...
Then we apply clustering within each position with k = 2 \## DF
